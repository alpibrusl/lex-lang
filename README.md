...
```sh
tar -xzf lex-v0.11.0-x86_64-unknown-linux-gnu.tar.gz
...
```sh
docker run -p 4040:4040 -v lex-store:/data ghcr.io/alpibrusl/lex:v0.11.0
docker run --rm -v "$(pwd):/work" -w /work ghcr.io/alpibrusl/lex:v0.11.0 check src/main.lex
```
