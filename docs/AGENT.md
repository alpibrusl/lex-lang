...
| `std.str` | `is_empty`, `to_int`, `to_float`, `concat`, `len`, `char_at`, `split`, `join`, `starts_with`, `ends_with`, `contains`, `cmp`, `replace`, `trim`, `to_upper`, `to_lower`, `strip_prefix`, `strip_suffix`, `slice`, `is_ascii`, `find`, `find_any` |
...
| `std.fs` | `read_to_string`, `write`, `append`, `exists`, `is_file`, `is_dir`, `stat`, `list_dir`, `walk`, `glob`, `mkdir_p`, `remove`, `copy` |
